...
if("TRUE" STREQUAL "TRUE")
  set(image_proc_SOURCE_PREFIX /home/kgreen/catkin_ws/src/image_pipeline/image_proc)
  set(image_proc_DEVEL_PREFIX /home/kgreen/catkin_ws/devel)
  ...
  set(image_proc_INSTALL_PREFIX /home/kgreen/catkin_ws/install)
...
if(NOT "/home/kgreen/catkin_ws/devel/include;/home/kgreen/catkin_ws/src/image_pipeline/image_proc/include;/usr/local/include;/usr/local/include/opencv " STREQUAL " ")
  set(image_proc_INCLUDE_DIRS "")
  set(_include_dirs "/home/kgreen/catkin_ws/devel/include;/home/kgreen/catkin_ws/src/image_pipeline/image_proc/include;/usr/local/include;/usr/local/include/opencv")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_proc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kgreen/catkin_ws/src/image_pipeline/image_proc/${idir}'.  Ask the maintainer 'Vincent Rabaud <vincent.rabaud@gmail.com>' to fix it.")
    endif()
    _list_append_unique(image_proc_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "image_proc;/usr/local/lib/libopencv_calib3d.so.3.1.0;/usr/local/lib/libopencv_core.so.3.1.0;/usr/local/lib/libopencv_features2d.so.3.1.0;/usr/local/lib/libopencv_flann.so.3.1.0;/usr/local/lib/libopencv_highgui.so.3.1.0;/usr/local/lib/libopencv_imgcodecs.so.3.1.0;/usr/local/lib/libopencv_imgproc.so.3.1.0;/usr/local/lib/libopencv_ml.so.3.1.0;/usr/local/lib/libopencv_objdetect.so.3.1.0;/usr/local/lib/libopencv_photo.so.3.1.0;/usr/local/lib/libopencv_shape.so.3.1.0;/usr/local/lib/libopencv_stitching.so.3.1.0;/usr/local/lib/libopencv_superres.so.3.1.0;/usr/local/lib/libopencv_video.so.3.1.0;/usr/local/lib/libopencv_videoio.so.3.1.0;/usr/local/lib/libopencv_videostab.so.3.1.0;/usr/local/lib/libopencv_viz.so.3.1.0")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/kgreen/catkin_ws/devel/lib;/home/kgreen/catkin_ws/devel/lib;/opt/ros/jade/lib)
